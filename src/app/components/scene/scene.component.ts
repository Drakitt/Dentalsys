...
import { extend, injectNgtLoader, NgtArgs, NgtBeforeRenderEvent, NgtPush, NgtStore } from 'angular-three';
...
export class Scene {
  readonly model$ = injectNgtLoader(GLTFLoader, 'assets/dentaldr.gltf').pipe(map((model) => model.scene));
}
